...
export const tools: Tool[] = [
  // --- Metadados ---
  {
    ...
    title: "Grupos CSAP (Portaria 221/2008)",
    description:
  ...
  },
  {
    ...
    title: "Anos disponíveis e frescor dos cubos",
    description:
  ...
  // --- Internações Gerais ---
  {
    ...
    title: "Internações do SUS com filtros",
    description:
  ...
  },
  {
    ...
    title: "Comparação entre UFs e regiões",
    description:
  ...
  {
    name: "get_icsap",
    title: "Internações por condições sensíveis (ICSAP)",
    description:
  ...
  },
  {
    ...
    title: "Tendências comparativas de ICSAP",
    description:
...
// =============================================================================
// DESPACHO — o mesmo para os dois transportes (stdio em src/index.ts, HTTP em
// src/http.ts). A factory de src/server.ts registra as doze ferramentas
// apontando para callTool(): trocar o transporte não muda o que a ferramenta
// devolve, e é isso que scripts/smoke-http.mjs prova contra o mesmo baseline.
// =============================================================================
